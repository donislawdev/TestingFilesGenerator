...
var assets = []Asset{
	...
	},
	{
		...
		Note:      "Symbols only - the toolkit's file, not the face the window is set in. Inter is a trademark of Rasmus Andersson. Neither licence file declares a Reserved Font Name, so the identifier is OFL-1.1 rather than OFL-1.1-RFN - checked in the files, not assumed.",
	},
	{
		Name:      "Inter",
		Package:   ourModule + "/internal/gui/font",
		Module:    ourModule,
		Files:     []string{"Inter-Regular.ttf", "Inter-Bold.ttf"},
		SPDX:      "OFL-1.1",
