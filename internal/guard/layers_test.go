...
var layer = map[string]int{
	...
	"internal/format/imagedim":   1,
	"internal/format/textenc":    1,
	...
	"internal/format/yamlfile":   1,
	"internal/format/tomlfile":   1,
...
var sameLayerAllowed = map[string][]string{
	...
	"internal/format/all": {
		...
		"internal/format/yamlfile",
		"internal/format/tomlfile",
	...
	"internal/format/textenc":    {"internal/format"},
	"internal/format/archive":    {"internal/format"},
	"internal/format/txt":        {"internal/format", "internal/format/imagelabel", "internal/format/textenc"},
	"internal/format/md":         {"internal/format", "internal/format/textenc"},
	"internal/format/logfile":    {"internal/format"},
	"internal/format/csvfile":    {"internal/format"},
	"internal/format/jsonfile":   {"internal/format"},
	"internal/format/yamlfile":   {"internal/format"},
	"internal/format/tomlfile":   {"internal/format", "internal/format/textenc"},
	"internal/format/xmlfile":    {"internal/format", "internal/format/textenc"},
	"internal/format/htmlfile":   {"internal/format"},
	"internal/format/svgfile":    {"internal/format", "internal/format/imagedim"},
	"internal/format/bmp":        {"internal/format", "internal/format/imagelabel", "internal/format/imagedim"},
	...
	"internal/format/gif":        {"internal/format", "internal/format/imagelabel", "internal/format/imagedim"},
	"internal/format/ico":        {"internal/format", "internal/format/imagelabel", "internal/format/imagedim"},
	"internal/format/jpg":        {"internal/format", "internal/format/imagelabel", "internal/format/imagedim"},
	"internal/format/png":        {"internal/format", "internal/format/imagelabel", "internal/format/imagedim"},
	...
	"internal/format/tiff":       {"internal/format", "internal/format/imagelabel", "internal/format/imagedim"},
